...
class Rossmann ( object ):
    def __init__( self ):
        self.rescaling_competition_distance      = pickle.load( open( 'parameters\rescaling_competition_distance.pkl', 'rb' ) )
        self.rescaling_competition_time_month    = pickle.load( open( 'parameters\rescaling_competition_time_month.pkl', 'rb' ) )
        self.rescaling_promo_time_week           = pickle.load( open( 'parameters\rescaling_promo_time_week.pkl', 'rb' ) )
        self.rescaling_year                      = pickle.load( open( 'parameters\rescaling_year.pkl', 'rb' ) )
        self.encoding_store_type                 = pickle.load( open( 'parameters\encoding_store_type.pkl', 'rb' ) )
